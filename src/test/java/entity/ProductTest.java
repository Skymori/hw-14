...
public class ProductTest {
    ...
    void setPrice() {
        ...
        assertThatThrownBy(() -> testProduct.setPrice(-1)).isInstanceOf(RuntimeException.class)
                .hasMessage("Price is not valid");

        assertThatThrownBy(() -> testProduct.setPrice(0)).isInstanceOf(RuntimeException.class)
                .hasMessage("Price is not valid");
    }
    @Test
    void setPromotionalPrice() {
        ...
        assertThatThrownBy(() -> testProduct.setPromotionalPrice(-1)).isInstanceOf(RuntimeException.class)
                .hasMessage("Price is not valid");

        assertThatThrownBy(() -> testProduct.setPromotionalPrice(0)).isInstanceOf(RuntimeException.class)
                .hasMessage("Price is not valid");
    }
    @Test
    void setPromotionalQuantity() {
        ...
        assertThatThrownBy(() -> testProduct.setPromotionalQuantity(-1)).isInstanceOf(RuntimeException.class)
                .hasMessage("Quantity is not valid");

        assertThatThrownBy(() -> testProduct.setPromotionalQuantity(0)).isInstanceOf(RuntimeException.class)
                .hasMessage("Quantity is not valid");
    }
    @Test
    void getPriceByQuantity() {
        ...
        assertThatThrownBy(() -> testProduct.getPriceByQuantity(-1)).isInstanceOf(RuntimeException.class)
